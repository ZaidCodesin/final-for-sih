'use strict';
/* ProtecT â€” database schema and additive migrations (node:sqlite, zero deps). */
const { DatabaseSync } = require('node:sqlite');
const path = require('path');
const fs = require('fs');

const DEFAULT_DATA_DIR = path.join(__dirname, '..', 'data');
const DB_PATH = process.env.ProtecT_DB_PATH
  ? path.resolve(process.env.ProtecT_DB_PATH)
